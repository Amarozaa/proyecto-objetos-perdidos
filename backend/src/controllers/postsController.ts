...
export const getPublicaciones = async (
  ...
  try {
    ...
    const publicaciones = await PublicacionModel.find(filtros)
...
export const getPublicacionPorId = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
  try {
    ...
    const publicacion = await PublicacionModel.findById(id).populate(
      "usuario_id",
...
export const createPublicacion = async (
  ...
  try {
    ...
    const nuevaPublicacion = new PublicacionModel({
      ...
      imagen_url: req.file
        ? `/api/images/publicaciones/${req.file.filename}`
        : datosPublicacion.imagen_url,
...
export const updatePublicacion = async (
  ...
  try {
    ...
    const publicacionActualizada = await PublicacionModel.findByIdAndUpdate(
      id,
